...
# PURPOSE: Evaluate localized chronological and temporal stability of the ICA solution.
# METHOD: Divide the signals into 10 contiguous localized blocks/windows and compute localized correlation.
...
p_originalUS <-
  ggplot(df_signals,
         aes(Time_sec, OriginalUS)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(a) Original Source (US)",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_originalRF <-
  ggplot(df_signals,
         aes(Time_sec, OriginalRF)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(a) Original Source (RF)",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_mixture1 <-
  ggplot(df_signals,
         aes(Time_sec, Mixture1)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(b) Mixture 1",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_mixture2 <-
  ggplot(df_signals,
         aes(Time_sec, Mixture2)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(b) Mixture 2",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_mixture1_filtered <-
  ggplot(df_signals,
         aes(Time_sec, Mixture1)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(d) Filtered Mixture 1",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_mixture2_filtered <-
  ggplot(df_signals,
         aes(Time_sec, Mixture2)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(d) Filtered Mixture 2",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_separated1 <-
  ggplot(df_signals,
         aes(Time_sec, Separated1)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(e) Estimated Component 1",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_separated2 <-
  ggplot(df_signals,
         aes(Time_sec, Separated2)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(e) Estimated Component 2",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_recovered1 <-
  ggplot(df_signals,
         aes(Time_sec, Recovered1)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(f) Reconstructed Mixture 1",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
p_recovered2 <-
  ggplot(df_signals,
         aes(Time_sec, Recovered2)) +
  geom_line(color="blue", linewidth=0.5) +
  labs(title="(f) Reconstructed Mixture 2",
       x="Time (s)",
       y="Amplitude") +
  theme_pub
...
# Vector PDF (recommended for LaTeX)

ggsave(
  "Figure_Simulated_Results.pdf",
  g,
  width = 8.5,
  height = 14,
  units = "in",
...
# TIFF 600 dpi (Elsevier)

ggsave(
  "Figure_Simulated_Results.tiff",
  g,
  width = 8.5,
  height = 14,
  units = "in",
